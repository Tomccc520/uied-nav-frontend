...
import CategorySidebar, { type SidebarConfig } from '../../components/CategorySidebar';
...
const EcommercePage: React.FC = () => {
  ...
  const { pageConfig, heroScrollWebsites } = usePageConfig('ecommerce', true);
    ...
    <div className="home-page ecommerce-page" style={{ '--bg-image': `url(${bgImage})` } as React.CSSProperties}>
      ...
      <div className="main-layout">
        ...
        <main className="tools-main">
          ...
          {/* 广告位 - 放在设计文章下方 */}
          <AdBanner pageSlug="ecommerce" position="top" limit={1} />
          ...
          {/* 底部广告位 */}
          <AdBanner pageSlug="ecommerce" position="bottom" limit={3} />
        </main>
      </div>
